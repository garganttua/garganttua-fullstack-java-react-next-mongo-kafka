...
ENV DB_URL=mongodb://backend:backend@noghost-mongo:27017/noghost
ENV KAFKA_URL=noghost:29092&maxPollRecords=1&enableAutoCommit=false&autoOffsetReset=latest&partitionsAutoScalling=true&allowAutoCreateTopics=true
USER spring:spring
ARG JAR_FILE=backend/target/noghost-backend-*.jar
